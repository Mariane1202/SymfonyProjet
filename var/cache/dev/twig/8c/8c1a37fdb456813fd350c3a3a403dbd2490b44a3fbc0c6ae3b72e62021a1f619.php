...
class __TwigTemplate_3290164781813e26eaeedddc9512b62c8d91d742c04e5b3377357efa113ba85d extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container\">
    ...
    <div class=\"row text-black\">
      <div class=\"col-12 col-lg-6 gradient shadow p-3\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["sorties"]) || array_key_exists("sorties", $context) ? $context["sorties"] : (function () { throw new RuntimeError('Variable "sorties" does not exist.', 33, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["sortie"]) {
            // line 34
            echo "                   <tr class=\"table-primary\">
                   <th scope=\"row\">";
            // line 35
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["sortie"], "id", [], "any", false, false, false, 35), "html", null, true);
            echo "</th>
                      <th scope=\"row\">";
            // line 36
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["sortie"], "product", [], "any", false, false, false, 36), "html", null, true);
            echo "</th>
                       <th scope=\"row\">";
            // line 37
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["sortie"], "dateS", [], "any", false, false, false, 37), "d-m-y"), "html", null, true);
            echo "</th>
                        <th scope=\"row\">";
            // line 38
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["sortie"], "quantite", [], "any", false, false, false, 38), "html", null, true);
            echo "</th
                   </tr>
                ...
                <tbody>
                  {% for sortie in sorties %}
                   ...
                   <th scope=\"row\">{{ sortie.id}}</th>
                      <th scope=\"row\">{{ sortie.product}}</th>
                       <th scope=\"row\">{{ sortie.dateS|date('d-m-y')}}</th>
                        <th scope=\"row\">{{ sortie.quantite}}</th
                   </tr>
...
{% endblock %}
", "sortie/index.html.twig", "C:\\xampp\\htdocs\\MESPROJETS\\appstock\\templates\\sortie\\index.html.twig");
    }
}
